...
export type GuideRailVisual = {
  id: string
  wallId: string
  style?: 'rail' | 'deflector' | 'lowerHardware' | 'slingGuard' | 'shortDeflector'
  width?: number
  alpha?: number
  startInset?: number
  endInset?: number
...
export const tableLayout = {
  ...
  guideRails: [
    ...
    { id: 'left-outlane-outer-rail', wallId: 'left-outlane-outer', style: 'lowerHardware', width: 17, alpha: 0.34, startInset: 18, endInset: 20, trimOffset: 9, trimAlpha: 0.38, endCaps: true, rivetSpacing: 92, rivetAlpha: 0.32 },
    { id: 'left-outlane-inner-rail', wallId: 'left-outlane-inner', style: 'slingGuard', width: 23, alpha: 0.5, startInset: 14, endInset: 18, trimOffset: 9, trimAlpha: 0.58, jadeEdge: true, endCaps: true, rivetSpacing: 62, rivetAlpha: 0.44 },
    { id: 'right-outlane-inner-rail', wallId: 'right-outlane-inner', style: 'slingGuard', width: 23, alpha: 0.5, startInset: 14, endInset: 18, trimOffset: 9, trimAlpha: 0.58, jadeEdge: true, endCaps: true, rivetSpacing: 62, rivetAlpha: 0.44 },
    { id: 'right-outlane-outer-rail', wallId: 'right-outlane-outer', style: 'lowerHardware', width: 17, alpha: 0.34, startInset: 18, endInset: 18, trimOffset: 9, trimAlpha: 0.38, endCaps: true, rivetSpacing: 92, rivetAlpha: 0.32 },
    { id: 'left-inlane-guide-rail', wallId: 'left-inlane', style: 'slingGuard', width: 28, alpha: 0.68, startInset: 16, endInset: 18, trimOffset: 10, trimAlpha: 0.78, jadeEdge: true, endCaps: true, rivetSpacing: 44, rivetAlpha: 0.56 },
    { id: 'right-inlane-guide-rail', wallId: 'right-inlane', style: 'slingGuard', width: 28, alpha: 0.68, startInset: 16, endInset: 18, trimOffset: 10, trimAlpha: 0.78, jadeEdge: true, endCaps: true, rivetSpacing: 44, rivetAlpha: 0.56 },
    { id: 'left-apron-guide-rail', wallId: 'left-apron', style: 'slingGuard', width: 30, alpha: 0.56, startInset: 18, endInset: 20, trimOffset: 12, trimAlpha: 0.64, endCaps: true, rivetSpacing: 46, rivetAlpha: 0.46 },
    { id: 'right-apron-guide-rail', wallId: 'right-apron', style: 'slingGuard', width: 30, alpha: 0.56, startInset: 18, endInset: 20, trimOffset: 12, trimAlpha: 0.64, endCaps: true, rivetSpacing: 46, rivetAlpha: 0.46 },
